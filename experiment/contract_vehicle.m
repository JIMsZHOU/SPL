function contract_vehicle

	[train_y1, train_x] = libsvmread('combined_scale');
    [test_y1, test_x] = libsvmread('combined_scale.t');

    train_y=zeros(78823,3);
    for i = 1:1:78823
        for ii = 1:3
            if train_y1(i,:) == ii
                train_y(i,ii) =1;
	...
	cnum= floor(num/3000); % SPLD cluster number
    cnum2 =floor(num/5000); % NSPLD cluster number
