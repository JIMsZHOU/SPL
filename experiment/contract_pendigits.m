function contract_pendigits

	[train_y1, train_x] = libsvmread('pendigits');
    [test_y1, test_x] = libsvmread('pendigits.t');

    train_y=zeros(7494,10);
    for i = 1:1:7494
        for ii = 1:10
            if train_y1(i,:) == ii-1
                train_y(i,ii) =1;
	...
	cnum=  30;%floor(num/300); % SPLD cluster number
    cnum2= 3;%floor(num/4000); % NSPLD cluster number
