function contract_mnist

	load mnist_uint8;

	in_x= double(train_x)/255; %#ok<NODEF>
	in_y= double(train_y); %#ok<NODEF>
    test_x = double(test_x)/255; %#ok<NODEF>
    test_y = double(test_y); %#ok<NODEF>
    ...
    cnum2 =floor(num/6000); % NSPLD cluster number
