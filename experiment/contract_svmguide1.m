function contract_svmguide1

	[train_y1, train_x] = libsvmread('svmguide1');
    [test_y1, test_x] = libsvmread('svmguide1.t');

    train_y=zeros(3089,2);
    for i = 1:1:3089
        for ii = 1:2
            if train_y1(i,:) == ii-1
                train_y(i,ii) =1;
    ...
    cnum2 =floor(num/1000); % NSPLD cluster number
