function contract_usps

	[train_y1, train_x] = libsvmread('usps');
    [test_y1, test_x] = libsvmread('usps.t');

    train_y=zeros(7291,10);
    for i = 1:1:7291
        for ii = 1:10
            if train_y1(i,:) == ii
                train_y(i,ii) =1;
	...
	cnum= 40;%floor(num/300); % SPLD cluster number
    cnum2=4;%floor(num/3000); % NSPLD cluster number
