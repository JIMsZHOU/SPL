function contract_ijcnn1

	[train_y1, train_x] = libsvmread('ijcnn1');
    [test_y1, test_x] = libsvmread('ijcnn1.t');

    train_y=zeros(49990,2);
    for i = 1:1:49990
        switch train_y1(i,:)
            case -1
                train_y(i,:) = [1 0];
    ...
    cnum2 =floor(num/4000); % NSPLD cluster number
